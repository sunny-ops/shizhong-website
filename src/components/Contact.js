  ...
  return (
    ...
    >
      ...
      <div className="app__wrapper app__flex" style={{ position: "relative" }}>
        ...
        <div class="app__footer-cards d-flex flex-row gap-5">
          <div class="app__footer-card">
            <img
              src="https://solely-resume.netlify.app/static/media/email.37b9e890eea501421fbf.png"
              alt="email"
            />
          ...
          <div class="app__footer-card">
            <img
              src="https://solely-resume.netlify.app/static/media/mobile.145d9ce0157a56f8fcd8.png"
              alt="phone"
            />
